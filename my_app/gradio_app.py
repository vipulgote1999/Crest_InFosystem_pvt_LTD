...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        question_input = gr.Textbox(label="❓ Ask a Question", placeholder="e.g., Explain the provided document?")
    
    submit_btn = gr.Button("💬 Get Answer")
    output = gr.Textbox(label="📘 Answer", lines=8)

    submit_btn.click(fn=gradio_rag_interface, inputs=[file_input, question_input], outputs=output)
